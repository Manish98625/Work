        ...
        <div class="card">
            <div class="card-body bg-light">
                <div class=" justify-content-center">
                    <div class="col-md-6">
                        <form action="{{ route('store') }}" method="post" class="p-4 progress-form"
                            ...
                            <section id="progress-form__panel-1" role="tabpanel" aria-labelledby="progress-form__tab-1"
                                ...
                                <fieldset eldset class="row mb-3 mt-3">
                                    <legend class="  h4 form-label   col-sm-4 pt-0 text-primary " name="gender">Gender
                                    </legend>
                                    <div class="col-sm-10">
                                ...
                                <fieldset id="product-purchase" name="skill[]" class="mt-3 form__field">
                                    ...
                                    <label class="form__choice-wrapper">
                                        <input type="checkbox" name="skill[]" value="PHP-laravel">
                    ...
                    <div class="col-8">
                        ...
                        <input type="file" name="image" class="form-control" id="formGroup" placeholder="">
                    </div>
